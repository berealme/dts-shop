...
public class DtsGrouponRulesService {
    ...
    private DtsGoods.Column[] goodsColumns = new DtsGoods.Column[]{DtsGoods.Column.id, DtsGoods.Column.name, DtsGoods.Column.brief, DtsGoods.Column.picUrl, DtsGoods.Column.counterPrice, DtsGoods.Column.retailPrice};

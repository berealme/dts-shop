...
public class DtsCouponService {
     ...
     * @return
     */
    public List<DtsCoupon> queryList(DtsCouponExample.Criteria criteria, int offset, int limit, String sort, String order) {
    ...
    public List<DtsCoupon> queryAvailableList(Integer userId, int offset, int limit) {
        ...
        List<DtsCouponUser> used = couponUserMapper.selectByExample(
                DtsCouponUserExample.newAndCreateCriteria().andUserIdEqualTo(userId).example()
        );
    ...
    public List<DtsCoupon> querySelective(String name, Short type, Short status, Integer page, Integer limit, String sort, String order) {
        DtsCouponExample example = new DtsCouponExample();
    ...
    public List<DtsCoupon> queryExpired() {
        DtsCouponExample example = new DtsCouponExample();
        example.or().andStatusEqualTo(CouponConstant.STATUS_NORMAL).andTimeTypeEqualTo(CouponConstant.TIME_TYPE_TIME).andEndTimeLessThan(LocalDate.now()).andDeletedEqualTo(false);
        return couponMapper.selectByExample(example);
    }
}

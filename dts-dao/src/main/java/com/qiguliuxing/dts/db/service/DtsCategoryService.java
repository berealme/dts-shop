...
public class DtsCategoryService {
    ...
    private DtsCategory.Column[] CHANNEL = {DtsCategory.Column.id, DtsCategory.Column.name, DtsCategory.Column.iconUrl};
    ...
    public List<DtsCategory> querySelective(String id, String name, Integer page, Integer size, String sort, String order) {
        DtsCategoryExample example = new DtsCategoryExample();

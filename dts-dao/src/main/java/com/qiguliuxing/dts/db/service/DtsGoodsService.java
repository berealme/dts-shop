...
public class DtsGoodsService {
    ...
    public List<DtsGoods> querySelective(Integer catId, Integer brandId, String keywords, Boolean isHot, Boolean isNew, Integer offset, Integer limit, String sort, String order) {
        DtsGoodsExample example = new DtsGoodsExample();
    ...
    public List<DtsGoods> querySelective(String goodsSn, String name, Integer page, Integer size, String sort, String order) {
        DtsGoodsExample example = new DtsGoodsExample();
	...
	public List<DtsGoods> queryByCategoryAndNotSameBrandId(int bid, int cid, int offset, int limit) {
		DtsGoodsExample example = new DtsGoodsExample();
        example.or().andBrandIdNotEqualTo(bid).andCategoryIdEqualTo(cid).andIsOnSaleEqualTo(true).andDeletedEqualTo(false);
        example.setOrderByClause("browse desc");
        PageHelper.startPage(offset, limit);
